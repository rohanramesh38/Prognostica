...
public class SignupUsername extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        nextB = findViewById(R.id.next_signup1);
    ...
    private boolean validateUsername() {
        if(username.length() ==10){
            ...
            username="";
            statusinfoTV.setText("enter a valid number");
            statusinfoTV.setTextColor(this.getResources().getColor(R.color.errorColor));
        }
        return false;
    }
